...
function formatEther(cell, _formatterParams, _onRendered) {
  return formatters.formatEther(cell.getValue());
}

function formatAvax(cell, _formatterParams, _onRendered) {
  return formatters.formatAvax(cell.getValue());
}

function formatUnixTime(cell, _formatterParams, _onRendered) {
  return formatters.unixToISO(cell.getValue());
}

function formatEtherPct(cell, _formatterParams, _onRendered) {
  return formatters.formatEtherPct(cell.getValue());
}

function formatMPStatus(cell, _formatterParams, _onRendered) {
  return formatters.formatMPStatus(cell.getValue());
}

function formatErrorMsg(cell, _formatterParams, _onRendered) {
  return formatters.formatErrorMsg(cell.getValue());
}

function labelAddress(cell, _formatterParams, _onRendered) {
  return formatters.labelAddress(cell.getValue(), DEPLOYMENT.EOALabels);
}

function formatTxID(cell, _formatterParams, _onRendered) {
...
const dashboardDef = {
  ...
  groupHeader: function (value, count, data, _group) {
